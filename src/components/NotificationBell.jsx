export default function NotificationBell({ unreadCount = 0, onClick, isOpen }) {
  return (
    <button
      ...
      className="cursor-pointer bg-transparent border-none p-1 shrink-0 transition-opacity duration-150 hover:opacity-70 relative flex items-center justify-center"
