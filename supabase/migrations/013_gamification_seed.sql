...
-- S'assurer que les colonnes créées manuellement (sans default) ont un default pour ne pas bloquer l'INSERT
alter table public.badge_definitions alter column icon_key        set default '';
alter table public.badge_definitions alter column condition_type  set default '';
do $$ begin alter table public.badge_definitions alter column condition_value set default 0; exception when undefined_column then null; end $$;
